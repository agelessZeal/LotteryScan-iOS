...
class SuperViewController:  BaseViewController ,UITextViewDelegate, NumberCellDelegate{
  ...
  @IBOutlet var result_title: UILabel!
    ...
    @IBAction func prize_view_touch(_ sender: Any) {
      ...
      let prize = ViewController.super_prize_str
    ...
    @IBAction func self_recheck_touch_in(_ sender: Any) {
      if  BaseViewController.isvaluechaed{
        
        BaseViewController.isselfrecheck = true
        self.performSegue(withIdentifier: "segue_super_back", sender: nil)
      }
...
func getTotalItemCount()->Int
{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if ( segue.identifier == "segue_super_back")
        {
...
extension SuperViewController: UICollectionViewDataSource {
...
extension SuperViewController: UICollectionViewDelegate {
...
extension SuperViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView,
      ...
      if (sansMutary1.count>0) {
        ...
        let cellheight = (collectionView.bounds.size.height - 3*(CGFloat)(all_row-1))/all_row;
